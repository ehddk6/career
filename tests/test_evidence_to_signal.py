...
def test_reliable_judge_detects_position_bias_and_cycle():
    ...
    r=compare_candidates("alpha","beta",rubric={"evidence":1,"fit":1},model_ids=["m1"],runner=runner);assert r["status"]=="evaluation_uncertain" and r["summary"]["position_flip_rate"]>0
    g=resolve_comparison_graph([{"candidate_a":"A","candidate_b":"B","winner":"A"},{"candidate_a":"B","candidate_b":"C","winner":"B"},{"candidate_a":"C","candidate_b":"A","winner":"C"}]);assert g["status"]=="evaluation_uncertain" and g["cycles"]
