{
  ...
  "output": "| Category | Weight | Detected | Raw Score | Weighted |\n|----------|--------|----------|-----------|----------|\n| content | 0.18 | 없음 | 0.0 | 0.0 |\n| language | 0.18 | 경미: 공식적 자기소개서 문체에서 일부 추상 표현 반복 | 4.2 | 0.8 |\n| style | 0.18 | 경미: 제출본 메모와 본문에 행정·평가식 표현 일부 | 5.6 | 1.0 |\n| communication | 0.13 | 없음 | 0.0 | 0.0 |\n| filler | 0.08 | 경미: “그 결과” 반복 등 문장 흐름의 약한 공식성 | 8.3 | 0.7 |\n| structure | 0.15 | 없음: 짧은 자기소개서 문항 구조로 장르상 허용 | 0.0 | 0.0 |\n| viral-hook | 0.1 | 없음 | 0.0 | 0.0 |\n| **Overall** | | | | **2.5 (±10)** |\n\n```yaml\ntone: null\ntone_source: profile_only\n```",
  "scores": {
    "llm": {
      "overall": 2.5,
