{
  ...
  "output": "| Category | Weight | Detected | Raw Score | Weighted |\n|----------|--------|----------|-----------|----------|\n| content | 0.18 | 없음 | 0.0 | 0.0 |\n| language | 0.18 | 약한 AI 특유 어휘 1건: “안정적으로”, “활용”, “개선” 등은 있으나 문맥상 자기소개서·업무 설명에 자연스러운 수준 | 4.2 | 0.8 |\n| style | 0.18 | 약한 연결/단계 표현 1건: “첫 단계”, “다음 단계”, “이후”, “그 결과”로 정돈된 계획형 문장이 이어짐 | 5.6 | 1.0 |\n| communication | 0.13 | 없음 | 0.0 | 0.0 |\n| filler | 0.08 | 없음 | 0.0 | 0.0 |\n| structure | 0.15 | 없음: 단락 수가 적고 자기소개서 문항 답변 구조상 반복으로 보기 어려움 | 0.0 | 0.0 |\n| viral-hook | 0.1 | 없음 | 0.0 | 0.0 |\n| **Overall** | | | | **1.8 (±10)** |\n\n```yaml\nphase_6:\n  ai_likeness_score: 1.8\n  interpretation: \"사람다움\"\n  tone: null\n  tone_source: profile_only\n  tone_evidence: []\n  tone_confidence: null\n```",
  "scores": {
    "llm": {
      "overall": 1.8,
