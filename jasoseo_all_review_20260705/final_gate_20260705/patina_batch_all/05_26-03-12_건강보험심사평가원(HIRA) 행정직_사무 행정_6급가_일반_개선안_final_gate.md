{
  ...
  "output": "| Category | Weight | Detected | Raw Score | Weighted |\n|----------|--------|----------|-----------|----------|\n| content | 0.18 | 없음 | 0.0 | 0.0 |\n| language | 0.18 | AI 특유 어휘 반복 Low; “보다” 비교부사 Low | 8.3 | 1.5 |\n| style | 0.18 | `~고 있다` 진행형 반복 Low; 공식어/한자어 반복 Low | 11.1 | 2.0 |\n| communication | 0.13 | 없음 | 0.0 | 0.0 |\n| filler | 0.08 | 채움 표현 Low; 과도한 헤징 Low | 16.7 | 1.3 |\n| structure | 0.15 | 구조적 반복 High; 번역체 Low | 26.7 | 4.0 |\n| viral-hook | 0.1 | 없음 | 0.0 | 0.0 |\n| **Overall** | | | | **8.8 (±10)** |\n\n```yaml\nphase_6:\n  ai_likeness_score: 8.8\n  interpretation: 사람다움\n  tone: null\n  tone_source: profile_only\n  note: 문항별 반복 구조와 일부 공식어가 보이지만, 과장·챗봇 표현·바이럴 훅은 거의 없습니다.\n```",
  "scores": {
    "llm": {
      "overall": 8.8,
